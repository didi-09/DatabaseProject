...
.sidebar h2 {
    ...
    border-bottom: 1px solid white; /* Optional: adds a border below the title */
}

.sidebar nav {
    display: flex;
    flex-direction: column;
    justify-content: flex-start; /* Align nav items from the top */
    align-items: center; /* Horizontally center the nav items */
    flex-grow: 1; /* Take up the remaining space */
    margin-top: 2rem; /* Space between title and nav items */
}
